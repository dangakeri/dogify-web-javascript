...
var _dogsView = require("./views/dogsView");
var _dogsViewDefault = parcelHelpers.interopDefault(_dogsView);
const controlImages = async function() {
    (0, _dogsViewDefault.default).renderSpinner();
    await _model.loadImages();
    (0, _dogsViewDefault.default).render(_model.state.dogs);
};
controlImages();
const init = function() {
    (0, _dogsViewDefault.default).addHandlerRefresh(controlImages);
};
init();

},{"./views/dogsView":"U1rzr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./model":"Y4A21"}],"U1rzr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aD7Zm","aenu9"], "aenu9", "parcelRequire8798")
